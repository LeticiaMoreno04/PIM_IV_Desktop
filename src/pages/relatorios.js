...
let enviaratendimento = document.getElementById("enviaratendimento");
    ...
    enviarfuncionario.addEventListener('click', function (event) {
        enviarEmail('funcionario-tab-pane');
    });

    enviaratendimento.addEventListener('click', function (event) {
        enviarEmail('atendimento-tab-pane');
    });
